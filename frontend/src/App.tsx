...
function App() {
  ...
  const saveFavorite = async () => {
    try {
      ...
      setError(requestError instanceof Error ? requestError.message : 'Could not save favorite.')
    }
  }
